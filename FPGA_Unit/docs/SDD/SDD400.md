...
flowchart TD
    ...
    style SPI fill:#440000
    style BRAM fill:#004400
    style FFT fill:#000044
    style LCD_CTRL fill:#444400
```
```
...
flowchart TD
    ...
    LORA[LoRa TX<br/>~4KB total]
     ...
     style IMG fill:#440000
     style FFT2D fill:#004400
     style GAUSS fill:#000044
     style LORA fill:#444400
```
