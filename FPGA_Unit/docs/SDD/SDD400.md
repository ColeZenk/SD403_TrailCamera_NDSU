...
flowchart TD
    ...
    style SPI fill:#ffcccc
    style BRAM fill:#ccffcc
    style FFT fill:#ccccff
    style LCD_CTRL fill:#ffffcc
```
```
...
flowchart TD
    ...
    LORA[LoRa TX<br/>~4KB total]
     ...
     style FFT2D fill:#ccffcc
     style GAUSS fill:#ccccff
     style LORA fill:#ffffcc
```
