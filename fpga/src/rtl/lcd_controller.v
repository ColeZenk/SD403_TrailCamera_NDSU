     ...
     output reg [4 : 0] lcd_b);
        ...
        always @(posedge clk or negedge rst_n) begin
                if (!rst_n) begin
                        ...
                        btn_s2 <= btn_s1;
                        btn_prev <= btn_stable;
                        db_cnt <= (db_cnt + {19'd0, btn_changed}) &
                                  {20{btn_changed}};
                        btn_stable <=
                            btn_stable ^ ((btn_stable ^ btn_s2) & db_done);
                end
        end
        ...
        wire bar_r =
                 (bar == 3'd0) | (bar == 3'd3) | (bar == 3'd4) | (bar == 3'd6);
        wire bar_g =
                 (bar == 3'd1) | (bar == 3'd3) | (bar == 3'd5) | (bar == 3'd6);
        wire bar_b =
                 (bar == 3'd2) | (bar == 3'd4) | (bar == 3'd5) | (bar == 3'd6);
        ...
        wire [4 : 0] raw_r = (p0_r | p1_r | p2_r | p3_r | p4_r | p5_r | p6_r |
                              p7_r) &
                             vis5;
        wire [5 : 0] raw_g = (p0_g | p1_g | p2_g | p3_g | p4_g | p5_g | p6_g |
                              p7_g) &
                             vis6;
        wire [4 : 0] raw_b = (p0_b | p1_b | p2_b | p3_b | p4_b | p5_b | p6_b |
                              p7_b) &
                             vis5;
