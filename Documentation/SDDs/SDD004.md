...
# Software Design Description 004 | LoRa Bench Test Protocol & Debug
...
`esp_timer_get_time()` returns microseconds. `>> 10` (÷1024) gives units of 1024 us each. All RTT values and the timeout comparison used 1024 µs as "1 ms," producing results 2.4% higher than actual and an effective timeout of 10.24 s instead of 10.00 s.
