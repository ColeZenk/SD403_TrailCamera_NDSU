...
# Table of Contents
- [SDD020 -- Keyframe Storage and Transmission Protocol](./SDD020.md)
...
flowchart LR
 ...
 subgraph FPGA_SYS["FPGA Accelerator"]
        ...
        WHT["2D WHT Engine"]
        COEFF["Coefficient<br>Thresholding"]
  end
 ...
 subgraph RECV_SYS["Receiver"]
    ...
    FPGA -- WHT --> WHT
    WHT -- Coefficients --> COEFF
    COEFF -- "Thresholded<br>SOMI" --> DEVKIT
    ...
    style WHT fill:#fff,stroke:#000,stroke-width:2px,color:#000
